...
def train_net(net):
    ...
    alphas_unsuper = net.hyperparameters["alphas_unsuper"]
    ...
    super_thr=net.hyperparameters["super_thr"]  # Ratio of supervised signal
    ...
    super_flag = np.random.rand(n_batches_train)<super_thr
    ...
    for epoch in range(n_epochs):
        ...
        for index in xrange(n_batches_train):
            # choose supervise or unsupervise
            s_flag = super_flag[index]
            #s_flag = True
                
            #net.change_batch_super_flag(s_flag)
            ...
            if not(s_flag):
                ...
                alphas_arg = alphas_unsuper + alphas_lat
                beta = np.float32(beta)
                Delta_log_all = net.unsupervised_phase(n_it_neg, epsilon, beta, *alphas_arg)
